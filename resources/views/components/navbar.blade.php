<nav class="bg-gray-800" x-data="{ isOpen: false }" x-data="{ isOpen: false }">
    ...
    <div 
          ...
          <a href="/posts" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Blog</a>
          ...
          <a href="/project" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Project</a> --}}
